...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    alcoholic_ingredients = set(drink_ingredients) & ALCOHOLS
...
def tag_special_ingredients(dish):
    ...
    special = SPECIAL_INGREDIENTS & ingredients
...
def singleton_ingredients(dishes, intersection):
    ...
    inters = set()
    for dish1 in dishes:
        symm_diffs = symm_diffs ^ dish1
        for dish2 in dishes:
            if dish1 == dish2:
                continue
            dish_intersection = dish1 & dish2
            inters = inters | dish_intersection
    singletons = symm_diffs - inters
    return singletons
